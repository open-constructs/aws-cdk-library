...
class InstanceConnectEndpointStack extends cdk.Stack {
  constructor(scope: Construct) {
    ...
    const instance = new cdk.aws_ec2.Instance(this, 'Instance', {
      vpc,
      instanceType: cdk.aws_ec2.InstanceType.of(cdk.aws_ec2.InstanceClass.C5, cdk.aws_ec2.InstanceSize.LARGE),
    ...
    const instanceConnectEndpoint = new ocf.aws_ec2.InstanceConnectEndpoint(this, 'InstanceConnectEndpoint', {
