...
/**
 * Abstract base class that implements common functionality for all Application Inference Profile variants
 */
abstract class ApplicationInferenceProfileBase extends Resource implements IApplicationInferenceProfile {
  /**
   * The ARN of the inference profile.
   */
   ...
   * The ID of the inference profile.
   */
  abstract readonly inferenceProfileId: string;

  /**
   * Internal implementation of grant logic
   */
  protected _grantInvokeImplementation(grantee: iam.IGrantable, options: GrantInvokeOptions = {}): iam.Grant {
